...
{block  name="title" prepend}Account Types{/block}
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" onclick="return false;">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;{if isset($a_TemplateData['accountTypeData']['id']) && $a_TemplateData['accountTypeData']['id'] > 0}Edit{else}Add New{/if}</h2>
                    ...
                    {if isset($a_TemplateData['accountTypeData']['showForm'])}
                    ...
                    <div class="box-content row" style="{if $showForm}display: block;{else}display: none;{/if}">
                        <div class="col-lg-12 col-md-12">
                                {if isset($a_TemplateData['accountTypeData']['id']) &&  $a_TemplateData['accountTypeData']['id'] > 0}
                                    {assign var=typeId value={$a_TemplateData['accountTypeData']['id']}}
                                {else}
                                    {assign var=typeId value=0}
                                {/if}
                                ...
                                <div class="form-group col-xs-4">
                                    <label for="name">
                                        Name
                                        <a data-toggle="tooltip" title="AccountType name Eg: Kilogram">
                                            <i class="glyphicon glyphicon-question-sign"></i>
                                        </a>
                                    </label>
                                    <input type="text" id="name" name="name" class="form-control" data-validation="alphanumeric server" data-validation-allowing="{$a_TemplateData['formValidChars']}" data-validation-url="{actionurl page=$ajaxFilePath params=["id"=>$typeId, "do"=>$a_TemplateData['VALIDATE']]}" data-validation-error-msg="Alphanumeric values only" value='{if isset($a_TemplateData['accountTypeData']['name'])}{$a_TemplateData['accountTypeData']['name']}{/if}' autocomplete="off" placeholder="AccountType name"/>
                                </div>
                                
                                <div class="form-group col-xs-4">
                                    {if isset ($a_TemplateData['accountTypeData']['status'])}
                                        {assign var="status" value=$a_TemplateData['accountTypeData']['status']}
                                    {else}
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <textarea id="notes" name="notes" class="form-control" data-validation="alphanumeric" data-validation-allowing="{$a_TemplateData['formValidChars']}" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> {if isset($a_TemplateData['accountTypeData']['notes'])}{$a_TemplateData['accountTypeData']['notes']}{/if}</textarea>
                                </div>
                                
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" id='addUnit'  type="submit" name="add_accounttype" value="{if isset($a_TemplateData['accountTypeData']['id']) && $a_TemplateData['accountTypeData']['id'] > 0}Save{else}Add{/if}"/>&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" name="addAccountType" value="addAccountType"/>
                ...
                <div class="box-inner">
                    ...
                    <div class="box-content row" style="{if $showForm}display: block;{else}display: none;{/if}">
                        <div class="col-lg-7 col-md-12 formContainer">
                                ...
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" type="submit" name="search_accountType" value="Search"/>&nbsp;&nbsp;&nbsp;
                            ...
                            <table id="tableData" class="display" cellspacing="0" width="100%" data-order='[[ 1, "asc" ]]'>
                                ...
                                <tfoot>
                                  <tr class="tablesorter-headerRow">
                                    ...
                                    <tbody>
                                    {if $a_TemplateData['allAccountTypes']}
                                        {foreach $a_TemplateData['allAccountTypes'] as $index=>$details}    
...
{block name="jsScriptBottoom"}
    ...
    <script>
        function init()
        {
            ...
            var tableOptions = {};
            {/literal}
            {if isset($a_TemplateData['allAccountTypes']) && $a_TemplateData['allAccountTypes']}
            {literal}
