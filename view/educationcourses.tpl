...
{block  name="title" prepend}Education Courses{/block}
...
{block name="content"}
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" onclick="return false;">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;{if isset($a_TemplateData['educationCourseData']['id']) && $a_TemplateData['educationCourseData']['id'] > 0}Edit{else}Add New{/if}</h2>
                    ...
                    {if isset($a_TemplateData['educationCourseData']['showForm'])}
                    ...
                    <div class="box-content row" style="{if $showForm}display: block;{else}display: none;{/if}">
                        <div class="col-lg-12 col-md-12">
                                {if isset($a_TemplateData['educationCourseData']['id']) &&  $a_TemplateData['educationCourseData']['id'] > 0}
                                    {assign var=educationCourseId value={$a_TemplateData['educationCourseData']['id']}}
                                {else}
                                    {assign var=educationCourseId value=0}
                                {/if}
                                <input type="hidden" name="id" value="{$educationCourseId}"/>
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" data-validation="alphanumeric server" data-validation-allowing="{$a_TemplateData['formValidChars']}"  data-validation-url="{actionurl page=$ajaxFilePath params=["do"=>$a_TemplateData['VALIDATE'],  "id"=>$educationCourseId]}" data-validation-error-msg="Alphanumeric values only" value='{if isset($a_TemplateData['educationCourseData']['name'])}{$a_TemplateData['educationCourseData']['name']}{/if}' autocomplete="off" placeholder=" name"/>
                                </div>
                                
                                <div class="form-group col-xs-4">
                                    {if isset ($a_TemplateData['educationCourseData']['status'])}
                                        {assign var="status" value=$a_TemplateData['educationCourseData']['status']}
                                    {else}
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <textarea id="notes" name="notes" class="form-control" data-validation="alphanumeric" data-validation-allowing="{$a_TemplateData['formValidChars']}" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> {if isset($a_TemplateData['educationCourseData']['notes'])}{$a_TemplateData['educationCourseData']['notes']}{/if}</textarea>
                                </div>
                                
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" id='addEducationCourse'  type="submit" name="add_educationCourse" value="{if isset($a_TemplateData['educationCourseData']['id']) && $a_TemplateData['educationCourseData']['id'] > 0}Save{else}Add{/if}"/>&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" name="addEducationCourse" value="Add"/>
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    ...
                    {*Search Form*}
                    {if isset($a_TemplateData['searchData']['search_educationCourse'])}
                        {assign var=showForm value=true}
                    {else}
                        {assign var=showForm value=false}
                    {/if}
                    ...
                    <div class="box-content row" style="{if $showForm}display: block;{else}display: none;{/if}">
                        <div class="col-lg-7 col-md-12 formContainer">
                                ...
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" type="submit" name="search_educationCourse" value="Search"/>&nbsp;&nbsp;&nbsp;
        ...
        <div class='row'>
            <div class="box">
                <div class="box-inner">
                    <div class="box-header well">
                        <h2><i class="glyphicon glyphicon-th-large"></i> EducationCourses</h2>
                        <div class="box-icon">
                            {*<a href="#" class="btn btn-setting btn-round btn-default"><i
                                    class="glyphicon glyphicon-cog"></i></a>*}
                            <a href="#" class="btn-minimize"><i
                        ...
                        <div class="box-content">
                            ...
                            <table id="tableData" class="display" cellspacing="0" width="100%" data-order='[[ 1, "asc" ]]'>
                                ...
                                <tfoot>  
                                    <tbody>
                                    {if $a_TemplateData['allEducationCourses']}
                                        {foreach $a_TemplateData['allEducationCourses'] as $index=>$details}    
                        ...
                        {if isset($a_TemplateData['allEducationCourses']) && $a_TemplateData['allEducationCourses']}
