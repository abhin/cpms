...
{block  name="title" prepend}Payement Methods{/block}
...
{block name="content"}
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" onclick="return false;">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;{if isset($a_TemplateData['paymentMethodData']['id']) && $a_TemplateData['paymentMethodData']['id'] > 0}Edit{else}Add New{/if}</h2>
                    ...
                    {if isset($a_TemplateData['paymentMethodData']['showForm'])}
                    ...
                    <div class="box-content row" style="{if $showForm}display: block;{else}display: none;{/if}">
                        <div class="col-lg-12 col-md-12">
                                {if isset($a_TemplateData['paymentMethodData']['id']) &&  $a_TemplateData['paymentMethodData']['id'] > 0}
                                    {assign var=paymentMethodId value={$a_TemplateData['paymentMethodData']['id']}}
                                {else}
                                ...
                                <div class="form-group col-xs-4">
                                    <label for="name">
                                        Name
                                        <a data-toggle="tooltip" title="Method name">
                                            <i class="glyphicon glyphicon-question-sign"></i>
                                        </a>
                                    </label>
                                    <input type="text" id="name" name="name" class="form-control" data-validation="alphanumeric server" data-validation-allowing="{$a_TemplateData['formValidChars']}"  data-validation-url="{actionurl page=$ajaxFilePath params=["do"=>$a_TemplateData['VALIDATE'], "id"=>$paymentMethodId]}" data-validation-error-msg="Alphanumeric values only" value='{if isset($a_TemplateData['paymentMethodData']['name'])}{$a_TemplateData['paymentMethodData']['name']}{/if}' autocomplete="off" placeholder="Method name"/>
                                </div>
                                
                                <div class="form-group col-xs-4">
                                    {if isset ($a_TemplateData['paymentMethodData']['status'])}
                                        {assign var="status" value=$a_TemplateData['paymentMethodData']['status']}
                                    {else}
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <textarea id="notes" name="notes" class="form-control" data-validation="alphanumeric" data-validation-allowing="{$a_TemplateData['formValidChars']}" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> {if isset($a_TemplateData['paymentMethodData']['notes'])}{$a_TemplateData['paymentMethodData']['notes']}{/if}</textarea>
                                </div>
                                
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" id='addPaymentMethod'  type="submit" name="add_paymentMethod" value="{if isset($a_TemplateData['paymentMethodData']['id']) && $a_TemplateData['paymentMethodData']['id'] > 0}Save{else}Add{/if}"/>&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" name="addPaymentMethod" value="Add"/>
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    ...
                    {*Search Form*}
                    {if isset($a_TemplateData['searchData']['search_paymentMethod'])}
                        {assign var=showForm value=true}
                    {else}
                        {assign var=showForm value=false}
                    {/if}
                    ...
                    <div class="box-content row" style="{if $showForm}display: block;{else}display: none;{/if}">
                        <div class="col-lg-7 col-md-12 formContainer">
                                ...
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" type="submit" name="search_paymentMethod" value="Search"/>&nbsp;&nbsp;&nbsp;
        ...
        <div class='row'>
            <div class="box">
                <div class="box-inner">
                    <div class="box-header well">
                        <h2><i class="glyphicon glyphicon-th-large"></i> Payement Methods</h2>
                        <div class="box-icon">
                            {*<a href="#" class="btn btn-setting btn-round btn-default"><i
                                    class="glyphicon glyphicon-cog"></i></a>*}
                            <a href="#" class="btn-minimize"><i
                        ...
                        <div class="box-content">
                           ...
                           <div class="showHideColumns">
                            ...
                            <table id="tableData" class="display" cellspacing="0" width="100%" data-order='[[ 1, "asc" ]]'>
                                ...
                                <tfoot> 
                                    <tbody>
                                    {if $a_TemplateData['allPaymentMethods']}
                                        {foreach $a_TemplateData['allPaymentMethods'] as $index=>$details}    
                                            <tr>
                                               <td>
                        ...
                        {if isset($a_TemplateData['allPaymentMethods']) && $a_TemplateData['allPaymentMethods']}
