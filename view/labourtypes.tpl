...
{block  name="title" prepend}Labour Types{/block}
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" onclick="return false;">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;{if isset($a_TemplateData['labourTypeData']['id']) && $a_TemplateData['labourTypeData']['id'] > 0}Edit{else}Add New{/if}</h2>
                    ...
                    {if isset($a_TemplateData['labourTypeData']['showForm'])}
                    ...
                    <div class="box-content row" style="{if $showForm}display: block;{else}display: none;{/if}">
                        <div class="col-lg-12 col-md-12">
                                {if isset($a_TemplateData['labourTypeData']['id']) &&  $a_TemplateData['labourTypeData']['id'] > 0}
                                    {assign var=labourTypeId value={$a_TemplateData['labourTypeData']['id']}}
                                {else}
                                    {assign var=labourTypeId value=0}
                                {/if}
                                <input type="hidden" name="id" value="{$labourTypeId}"/>
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" data-validation="alphanumeric server" data-validation-allowing="{$a_TemplateData['formValidChars']}"  data-validation-url="{actionurl page=$ajaxFilePath params=["do"=>$a_TemplateData['VALIDATE'],  "id"=>$labourTypeId]}" data-validation-error-msg="Alphanumeric values only" value='{if isset($a_TemplateData['labourTypeData']['name'])}{$a_TemplateData['labourTypeData']['name']}{/if}' autocomplete="off" placeholder=" name"/>
                                </div>
                                
                                <div class="form-group col-xs-4">
                                    {if isset ($a_TemplateData['labourTypeData']['status'])}
                                        {assign var="status" value=$a_TemplateData['labourTypeData']['status']}
                                    {else}
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <textarea id="notes" name="notes" class="form-control" data-validation="alphanumeric" data-validation-allowing="{$a_TemplateData['formValidChars']}" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> {if isset($a_TemplateData['labourTypeData']['notes'])}{$a_TemplateData['labourTypeData']['notes']}{/if}</textarea>
                                </div>
                                
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" id='addLabourType'  type="submit" name="add_labourType" value="{if isset($a_TemplateData['labourTypeData']['id']) && $a_TemplateData['labourTypeData']['id'] > 0}Save{else}Add{/if}"/>&nbsp;&nbsp;&nbsp;
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    ...
                    {*Search Form*}
                    {if isset($a_TemplateData['searchData']['search_labourType'])}
                        {assign var=showForm value=true}
                    {else}
                        {assign var=showForm value=false}
                    {/if}
                    ...
                    <div class="box-header well">
                        ...
                        <div class="box-content">
                            ...
                            <table id="tableData" class="display" cellspacing="0" width="100%" data-order='[[ 1, "asc" ]]'>
                                ...
                                <tfoot>  
                                    <tbody>
                                    {if $a_TemplateData['allLabourTypes']}
                                        {foreach $a_TemplateData['allLabourTypes'] as $index=>$details}    
                        ...
                        {if isset($a_TemplateData['allLabourTypes']) && $a_TemplateData['allLabourTypes']}
