...
{block  name="title" prepend}Employment Types{/block}
...
{block name="content"}
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" onclick="return false;">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;{if isset($a_TemplateData['employmentTypeData']['id']) && $a_TemplateData['employmentTypeData']['id'] > 0}Edit{else}Add New{/if}</h2>
                    ...
                    {if isset($a_TemplateData['employmentTypeData']['showForm'])}
                    ...
                    <div class="box-content row" style="{if $showForm}display: block;{else}display: none;{/if}">
                        <div class="col-lg-12 col-md-12">
                                {if isset($a_TemplateData['employmentTypeData']['id']) &&  $a_TemplateData['employmentTypeData']['id'] > 0}
                                    {assign var=employmentTypeId value={$a_TemplateData['employmentTypeData']['id']}}
                                {else}
                                    {assign var=employmentTypeId value=0}
                                {/if}
                                <input type="hidden" name="id" value="{$employmentTypeId}"/>
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" data-validation="alphanumeric server" data-validation-allowing="{$a_TemplateData['formValidChars']}"  data-validation-url="{actionurl page=$ajaxFilePath params=["do"=>$a_TemplateData['VALIDATE'],  "id"=>$employmentTypeId]}" data-validation-error-msg="Alphanumeric values only" value='{if isset($a_TemplateData['employmentTypeData']['name'])}{$a_TemplateData['employmentTypeData']['name']}{/if}' autocomplete="off" placeholder="Term name"/>
                                </div>
                                
                                <div class="form-group col-xs-4">
                                    {if isset ($a_TemplateData['employmentTypeData']['status'])}
                                        {assign var="status" value=$a_TemplateData['employmentTypeData']['status']}
                                    {else}
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <textarea id="notes" name="notes" class="form-control" data-validation="alphanumeric" data-validation-allowing="{$a_TemplateData['formValidChars']}" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> {if isset($a_TemplateData['employmentTypeData']['notes'])}{$a_TemplateData['employmentTypeData']['notes']}{/if}</textarea>
                                </div>
                                
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" id='addEmploymentType'  type="submit" name="add_employmentType" value="{if isset($a_TemplateData['employmentTypeData']['id']) && $a_TemplateData['employmentTypeData']['id'] > 0}Save{else}Add{/if}"/>&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" name="addEmploymentType" value="Add"/>
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    ...
                    {*Search Form*}
                    {if isset($a_TemplateData['searchData']['search_employmentType'])}
                        {assign var=showForm value=true}
                    {else}
                        {assign var=showForm value=false}
                    {/if}
                    ...
                    <div class="box-content row" style="{if $showForm}display: block;{else}display: none;{/if}">
                        <div class="col-lg-7 col-md-12 formContainer">
                                ...
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" type="submit" name="search_employmentType" value="Search"/>&nbsp;&nbsp;&nbsp;
        ...
        <form method="post" class="form-inline bulkForm" action="{actionurl page=$actionPage}">
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well">
                       <h2><i class="glyphicon glyphicon-th-large"></i> Employment Types</h2>
                        <div class="box-icon">
                            {*<a href="#" class="btn btn-setting btn-round btn-default"><i
                                    class="glyphicon glyphicon-cog"></i></a>*}
                            <a href="#" class="btn-minimize"><i
                    ...
                    <div class="box-content">
                            ...
                            <table id="tableData" class="display" cellspacing="0" width="100%" data-order='[[ 1, "asc" ]]'>
                                ...
                                <tfoot>
                                  <tr class="tablesorter-headerRow">
                                    ...
                                    <tbody>
                                    {if $a_TemplateData['allEmploymentTypes']}
                                        {foreach $a_TemplateData['allEmploymentTypes'] as $index=>$details}    
                        ...
                        {if isset($a_TemplateData['allEmploymentTypes']) && $a_TemplateData['allEmploymentTypes']}
