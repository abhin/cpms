...
{block  name="title" prepend}Designations{/block}
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" onclick="return false;">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;{if isset($a_TemplateData['designationData']['id']) && $a_TemplateData['designationData']['id'] > 0}Edit{else}Add New{/if}</h2>
                    ...
                    {if isset($a_TemplateData['designationData']['showForm'])}
                    ...
                    <div class="box-content row" style="{if $showForm}display: block;{else}display: none;{/if}">
                        <div class="col-lg-12 col-md-12">
                                {if isset($a_TemplateData['designationData']['id']) &&  $a_TemplateData['designationData']['id'] > 0}
                                    {assign var=designationId value={$a_TemplateData['designationData']['id']}}
                                {else}
                                    {assign var=designationId value=0}
                                {/if}
                                <input type="hidden" name="id" value="{$designationId}"/>
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" data-validation="alphanumeric server" data-validation-allowing="{$a_TemplateData['formValidChars']}"  data-validation-url="{actionurl page=$ajaxFilePath params=["do"=>$a_TemplateData['VALIDATE'],  "id"=>$designationId]}" data-validation-error-msg="Alphanumeric values only" value='{if isset($a_TemplateData['designationData']['name'])}{$a_TemplateData['designationData']['name']}{/if}' autocomplete="off" placeholder=" name"/>
                                </div>
                                
                                <div class="form-group col-xs-4">
                                    {if isset ($a_TemplateData['designationData']['status'])}
                                        {assign var="status" value=$a_TemplateData['designationData']['status']}
                                    {else}
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <textarea id="notes" name="notes" class="form-control" data-validation="alphanumeric" data-validation-allowing="{$a_TemplateData['formValidChars']}" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> {if isset($a_TemplateData['designationData']['notes'])}{$a_TemplateData['designationData']['notes']}{/if}</textarea>
                                </div>
                                
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" id='addDesignation'  type="submit" name="add_designation" value="{if isset($a_TemplateData['designationData']['id']) && $a_TemplateData['designationData']['id'] > 0}Save{else}Add{/if}"/>&nbsp;&nbsp;&nbsp;
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    ...
                    {*Search Form*}
                    {if isset($a_TemplateData['searchData']['search_designation'])}
                        {assign var=showForm value=true}
                    {else}
                        {assign var=showForm value=false}
                    {/if}
                    ...
                    <div class="box-header well">
                        ...
                        <div class="box-content">
                            ...
                            <table id="tableData" class="display" cellspacing="0" width="100%" data-order='[[ 1, "asc" ]]'>
                                ...
                                <tfoot>  
                                    <tbody>
                                    {if $a_TemplateData['allDesignations']}
                                        {foreach $a_TemplateData['allDesignations'] as $index=>$details}    
                        ...
                        {if isset($a_TemplateData['allDesignations']) && $a_TemplateData['allDesignations']}
