<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-06-28 18:32:49
         compiled from "C:/xampp/htdocs/products/CPMS/view/advances.tpl" */ ?>
<?php /*%%SmartyHeaderCode:237855b34dc7930dd29-95744973%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '06e62aabe0c3f766e656d0a5f075f434204023d9' => 
    array (
      0 => 'C:/xampp/htdocs/products/CPMS/view/advances.tpl',
      1 => 1450505030,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '237855b34dc7930dd29-95744973',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b34dc79a01170_79352058',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b34dc79a01170_79352058')) {function content_5b34dc79a01170_79352058($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\products\\CPMS\\model\\lib\\smarty/plugins/modifier.replace.php';
...
<head>
 ...
 :: Revenue-<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['a_TemplateData']->value['clientName'],true);?>
</title>
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i> <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['advanceData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['advanceData']['id']>0) {?>Update<?php } else { ?>Add New<?php }?></h2>
...
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['advanceData']['amount'];
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <input type="text" id="receivedDate" name="receivedDate" class="form-control datePicker" data-validation="date" data-validation-format="yyyy-mm-dd" data-validation-error-msg="Invalid date" value='<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['advanceData']['receivedDate'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['advanceData']['receivedDate'];
}?>' autocomplete="off"/>
                                </div>
                                    <div class="form-group col-xs-4">
...
" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['advanceData']['notes'])) {
...
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['amount'];
                                    ...
                                    <div class="form-group col-xs-4">
                                    <label for="receivedDate" class="control-label">Received Date</label>
                                    <input type="text" id="searchReceivedDate" name="receivedDate" class="form-control datePicker" data-validation="date" data-validation-format="yyyy-mm-dd" data-validation-error-msg="Invalid date" value='<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['receivedDate'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['receivedDate'];
...
" />
                                           ...
                                           <td><?php echo $_smarty_tpl->tpl_vars['details']->value->projectName;?>
</td>
                                           <td><?php echo $_smarty_tpl->tpl_vars['details']->value->amount;?>
</td>
                                           <td><?php echo $_smarty_tpl->tpl_vars['details']->value->receivedDate;?>
</td>
                                           <td><?php echo $_smarty_tpl->tpl_vars['details']->value->notes;?>
</td>
                                           <td>
                                               <a class="btn btn-info btn-small" href="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['actionPage']->value,'params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'projectId'=>$_smarty_tpl->tpl_vars['details']->value->projectId,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['EDIT'])),$_smarty_tpl);?>
">
                                                   <i class="glyphicon glyphicon-edit icon-white"></i>
                                                   Edit
                                               </a>
                                               <a class="btn btn-danger btn-small delete" href="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['actionPage']->value,'params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'projectId'=>$_smarty_tpl->tpl_vars['details']->value->projectId,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['DELETE'])),$_smarty_tpl);?>
">
...
>
        function init()
        {
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['allAdvance'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['allAdvance']) {?>
