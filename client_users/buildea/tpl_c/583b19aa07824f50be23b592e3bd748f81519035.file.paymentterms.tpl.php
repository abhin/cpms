<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-06-28 18:32:53
         compiled from "C:/xampp/htdocs/products/CPMS/view/paymentterms.tpl" */ ?>
<?php /*%%SmartyHeaderCode:107955b34dc7d2f85e3-01980575%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '583b19aa07824f50be23b592e3bd748f81519035' => 
    array (
      0 => 'C:/xampp/htdocs/products/CPMS/view/paymentterms.tpl',
      1 => 1451026125,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '107955b34dc7d2f85e3-01980575',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b34dc7d5414e0_23743909',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b34dc7d5414e0_23743909')) {function content_5b34dc7d5414e0_23743909($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\products\\CPMS\\model\\lib\\smarty/plugins/modifier.replace.php';
...
<head>
 ...
 :: Payement Terms-<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['a_TemplateData']->value['clientName'],true);?>
</title>
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" onclick="return false;">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['id']>0) {?>Edit<?php } else { ?>Add New<?php }?></h2>
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['showForm'])) {?>
                    ...
                    <div class="box-content row" style="<?php if ($_smarty_tpl->tpl_vars['showForm']->value) {?>display: block;<?php } else { ?>display: none;<?php }?>">
                        <div class="col-lg-12 col-md-12">
                                <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['id']>0) {?>
                                    <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['id'];?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['paymentTermId'] = new Smarty_variable($_tmp1, null, 0);?>
                                <?php } else { ?>
                                    <?php $_smarty_tpl->tpl_vars['paymentTermId'] = new Smarty_variable(0, null, 0);?>
                                <?php }?>
                                <input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['paymentTermId']->value;?>
"/>
...
"  data-validation-url="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['ajaxFilePath']->value,'params'=>array("do"=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['VALIDATE'],"id"=>$_smarty_tpl->tpl_vars['paymentTermId']->value)),$_smarty_tpl);?>
" data-validation-error-msg="Alphanumeric values only" value='<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['name'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['name'];
}?>' autocomplete="off" placeholder="Term name"/>
                                </div>
                                
                                <div class="form-group col-xs-4">
                                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['status'])) {?>
                                        <?php $_smarty_tpl->tpl_vars["status"] = new Smarty_variable($_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['status'], null, 0);?>
                                    <?php } else { ?>
...
" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['notes'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['notes'];
}?></textarea>
                                </div>
                                
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" id='addPaymentTerm'  type="submit" name="add_paymentTerm" value="<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['paymentTermData']['id']>0) {?>Save<?php } else { ?>Add<?php }?>"/>&nbsp;&nbsp;&nbsp;
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['search_paymentTerm'])) {?>
                        <?php $_smarty_tpl->tpl_vars['showForm'] = new Smarty_variable(true, null, 0);?>
                    <?php } else { ?>
                        <?php $_smarty_tpl->tpl_vars['showForm'] = new Smarty_variable(false, null, 0);?>
                    <?php }?>
...
?>
                                    ...
                                    <tbody>
                                    <?php if ($_smarty_tpl->tpl_vars['a_TemplateData']->value['allPaymentTerms']) {?>
...
" />
                                               ...
                                               <td>
                                                   <a class="btn btn-info btn-small" href="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['actionPage']->value,'params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['EDIT'])),$_smarty_tpl);?>
">
                                                       <i class="glyphicon glyphicon-edit icon-white"></i>
                                                       Edit
                                                   </a>
                                                   <a class="btn btn-danger btn-small delete" href="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['actionPage']->value,'params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['DELETE'])),$_smarty_tpl);?>
">
                        ...
                        <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['allPaymentTerms'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['allPaymentTerms']) {?>
