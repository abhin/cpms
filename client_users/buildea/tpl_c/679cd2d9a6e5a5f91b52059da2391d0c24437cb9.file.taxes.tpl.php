<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-12-06 17:57:01
         compiled from "D:/xampp/htdocs/products/cpms/view/taxes.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2810656642995a996a9-56410511%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '679cd2d9a6e5a5f91b52059da2391d0c24437cb9' => 
    array (
      0 => 'D:/xampp/htdocs/products/cpms/view/taxes.tpl',
      1 => 1449398988,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2810656642995a996a9-56410511',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56642995ea1a12_13613598',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56642995ea1a12_13613598')) {function content_56642995ea1a12_13613598($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'D:\\xampp\\htdocs\\products\\CPMS\\model\\lib\\smarty/plugins/modifier.replace.php';
...
<head>
 ...
 :: Taxes-<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['a_TemplateData']->value['clientName'],true);?>
</title>
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" onclick="return false;">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['id']>0) {?>Edit<?php } else { ?>Add New<?php }?></h2>
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['showForm'])) {?>
                    ...
                    <div class="box-content row" style="<?php if ($_smarty_tpl->tpl_vars['showForm']->value) {?>display: block;<?php } else { ?>display: none;<?php }?>">
                        <div class="col-lg-12 col-md-12">
                            <form action="<?php echo smarty_function_actionurl(array('page'=>'taxes'),$_smarty_tpl);?>
" method="post" class="form-inline addForm"  style="text-align: center;">
                                <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['id']>0) {?>
                                    <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['id'];?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['taxId'] = new Smarty_variable($_tmp1, null, 0);?>
                                <?php } else { ?>
                                    <?php $_smarty_tpl->tpl_vars['taxId'] = new Smarty_variable(0, null, 0);?>
                                <?php }?>
                                <input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['taxId']->value;?>
"/>
                                    
                                <div class="form-group col-xs-4">
                                    <label for="name">
                                        Name
                                        <a data-toggle="tooltip" title="Tax name">
...
"  data-validation-url="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['ajaxFilePath']->value,'params'=>array("do"=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['VALIDATE'],"id"=>$_smarty_tpl->tpl_vars['taxId']->value)),$_smarty_tpl);?>
" data-validation-error-msg="Alphanumeric values only" value='<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['name'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['name'];
}?>' autocomplete="off" placeholder="Tax name"/>
                                </div>
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <div class="input-group" style="width:100% !important;">
                                        <input type="text" id="precentage" name="precentage" class="form-control" data-validation="number" data-validation-error-msg="Invalid precentage"  data-validation-allowing="float" value='<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['precentage'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['precentage'];
}?>' autocomplete="off" placeholder="Tax Precentage" style="width:100% !important;"/>
                                        <div class="input-group-addon">%</div>
                                    </div>
                                </div>
                                
                                <div class="form-group col-xs-4">
                                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['isDefault'])) {?>
                                        <?php $_smarty_tpl->tpl_vars["isDefault"] = new Smarty_variable($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['isDefault'], null, 0);?>
                                    <?php } else { ?>
                                        <?php $_smarty_tpl->tpl_vars["isDefault"] = new Smarty_variable(2, null, 0);?>
                                    <?php }?>
                                    <label for="is" >
                                        Is Default
                                    </label>
                                    <select id="isDefault" name="isDefault" class="form-control chosen-select" data-validation="number" data-validation-error-msg="Invalid selection" >
                                        <option value="1" <?php if ($_smarty_tpl->tpl_vars['isDefault']->value==1) {?>selected='selected'<?php }?>>
                                            Yes
                                        </option>
                                        <option value="2" <?php if ($_smarty_tpl->tpl_vars['isDefault']->value==2) {?>selected='selected'<?php }?>>
                                            No
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-xs-12">
                                <div class="form-group col-xs-4">
                                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['status'])) {?>
                                        <?php $_smarty_tpl->tpl_vars["status"] = new Smarty_variable($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['status'], null, 0);?>
                                    <?php } else { ?>
...
" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['notes'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['notes'];
}?></textarea>
                                </div>
                                </div>
                                
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" id='addTax'  type="submit" name="add_tax" value="<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['taxData']['id']>0) {?>Save<?php } else { ?>Add<?php }?>"/>&nbsp;&nbsp;&nbsp;
                                    <a class="btn btn-default resetFormData" type="reset" href="<?php echo smarty_function_actionurl(array('page'=>'taxes'),$_smarty_tpl);?>
">Clear</a>
                                </div>
                            </form>
                        </div>
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['search_tax'])) {?>
                        <?php $_smarty_tpl->tpl_vars['showForm'] = new Smarty_variable(true, null, 0);?>
                    <?php } else { ?>
                        <?php $_smarty_tpl->tpl_vars['showForm'] = new Smarty_variable(false, null, 0);?>
                    <?php }?>
...
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['name'];
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <div class="input-group" style="width:100% !important;">
                                        <input type="text" name="precentage" class="form-control" data-validation="number" data-validation-error-msg="Invalid precentage"  data-validation-allowing="float" data-validation-optional="true" value='<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['precentage'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['precentage'];
}?>' autocomplete="off" placeholder="Tax Precentage" style="width:100% !important;"/>
                                        <div class="input-group-addon">%</div>
                                    </div>
                                </div>
...
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['notes'];
                                ...
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" type="submit" name="search_tax" value="Search"/>&nbsp;&nbsp;&nbsp;
        ...
        <form method="post" class="bulkForm" action="<?php echo smarty_function_actionurl(array('page'=>'taxes'),$_smarty_tpl);?>
">
                            <div class='row'>
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well">
                        <h2><i class="glyphicon glyphicon-th-large"></i> Taxes</h2>
                        <div class="box-icon">
...
?>
                                ...
                                <tbody>
                                    <?php if ($_smarty_tpl->tpl_vars['a_TemplateData']->value['allTaxes']) {?>
                                        <?php  $_smarty_tpl->tpl_vars['details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['details']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['a_TemplateData']->value['allTaxes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" />
                                               ...
                                               <td><?php echo $_smarty_tpl->tpl_vars['details']->value->precentage;?>
%</td>
                                               <td>
                                                    <?php if ($_smarty_tpl->tpl_vars['details']->value->isDefault!=1) {?>
                                                        <input type="radio" name="notDefaultTax" value="<?php echo $_smarty_tpl->tpl_vars['details']->value->id;?>
" />
                                                    <?php } else { ?>
                                                        <span id="defaultTax_<?php echo $_smarty_tpl->tpl_vars['details']->value->id;?>
">
                                               ...
                                               <td>
                                                   <a class="btn btn-info btn-small" data-toggle="tooltip" data-original-title="Edit tax." href="<?php echo smarty_function_actionurl(array('page'=>'taxes','params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['EDIT'])),$_smarty_tpl);?>
">
                                                       <i class="glyphicon glyphicon-edit icon-white"></i>
                                                       Edit
                                                   </a>
                                                   <a class="btn btn-danger btn-small delete" data-toggle="tooltip" data-original-title="Delete tax." href="<?php echo smarty_function_actionurl(array('page'=>'taxes','params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['DELETE'])),$_smarty_tpl);?>
">
...
>
        function init(){
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['allTaxes'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['allTaxes']) {?>
...
, tableOptions, setDefaultCallback);
            
            function setDefaultCallback(){
                setDefaultTax('<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['ajaxFilePath']->value),$_smarty_tpl);?>
');
            }
            setDefaultCallback();
        }
