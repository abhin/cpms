<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-02-06 14:06:39
         compiled from "D:/xampp/htdocs/products/cpms/view/labourtypes.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2332556b5b0974786f7-78506086%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd12a638bbd12600c9064f2705d36d462dedf5e2b' => 
    array (
      0 => 'D:/xampp/htdocs/products/cpms/view/labourtypes.tpl',
      1 => 1453538566,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2332556b5b0974786f7-78506086',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56b5b09791ecd7_44199455',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56b5b09791ecd7_44199455')) {function content_56b5b09791ecd7_44199455($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'D:\\xampp\\htdocs\\products\\CPMS\\model\\lib\\smarty/plugins/modifier.replace.php';
...
<head>
 ...
 :: Labour Types-<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['a_TemplateData']->value['clientName'],true);?>
</title>
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" onclick="return false;">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['id']>0) {?>Edit<?php } else { ?>Add New<?php }?></h2>
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['showForm'])) {?>
                    ...
                    <div class="box-content row" style="<?php if ($_smarty_tpl->tpl_vars['showForm']->value) {?>display: block;<?php } else { ?>display: none;<?php }?>">
                        <div class="col-lg-12 col-md-12">
                                <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['id']>0) {?>
                                    <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['id'];?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['labourTypeId'] = new Smarty_variable($_tmp1, null, 0);?>
                                <?php } else { ?>
                                    <?php $_smarty_tpl->tpl_vars['labourTypeId'] = new Smarty_variable(0, null, 0);?>
                                <?php }?>
                                <input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['labourTypeId']->value;?>
"/>
...
"  data-validation-url="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['ajaxFilePath']->value,'params'=>array("do"=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['VALIDATE'],"id"=>$_smarty_tpl->tpl_vars['labourTypeId']->value)),$_smarty_tpl);?>
" data-validation-error-msg="Alphanumeric values only" value='<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['name'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['name'];
}?>' autocomplete="off" placeholder=" name"/>
                                </div>
                                
                                <div class="form-group col-xs-4">
                                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['status'])) {?>
                                        <?php $_smarty_tpl->tpl_vars["status"] = new Smarty_variable($_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['status'], null, 0);?>
                                    <?php } else { ?>
...
" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['notes'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['notes'];
}?></textarea>
                                </div>
                                
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" id='addLabourType'  type="submit" name="add_labourType" value="<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['labourTypeData']['id']>0) {?>Save<?php } else { ?>Add<?php }?>"/>&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" name="addLabourType" value="Add"/>
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['search_labourType'])) {?>
                        <?php $_smarty_tpl->tpl_vars['showForm'] = new Smarty_variable(true, null, 0);?>
                    <?php } else { ?>
                        <?php $_smarty_tpl->tpl_vars['showForm'] = new Smarty_variable(false, null, 0);?>
                    <?php }?>
...
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['notes'];
                                ...
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" type="submit" name="search_labourType" value="Search"/>&nbsp;&nbsp;&nbsp;
...
">
        <div class='row'>
            <div class="box">
                <div class="box-inner">
                    <div class="box-header well">
                        <h2><i class="glyphicon glyphicon-th-large"></i> LabourTypes</h2>
                        <div class="box-icon">
...
"<?php }?>><?php echo $_smarty_tpl->tpl_vars['head']->value['name'];?>
                                ...
                                <tfoot>  
                                    <tbody>
                                    <?php if ($_smarty_tpl->tpl_vars['a_TemplateData']->value['allLabourTypes']) {?>
                                        <?php  $_smarty_tpl->tpl_vars['details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['details']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['a_TemplateData']->value['allLabourTypes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
">
                        ...
                        <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['allLabourTypes'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['allLabourTypes']) {?>
