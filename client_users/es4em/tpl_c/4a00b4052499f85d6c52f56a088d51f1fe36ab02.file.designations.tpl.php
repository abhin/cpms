<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-06-28 18:59:35
         compiled from "C:/xampp/htdocs/products/CPMS/view/designations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139295b34e2bf099b06-66248654%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4a00b4052499f85d6c52f56a088d51f1fe36ab02' => 
    array (
      0 => 'C:/xampp/htdocs/products/CPMS/view/designations.tpl',
      1 => 1450548187,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '139295b34e2bf099b06-66248654',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b34e2bf350218_55635132',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b34e2bf350218_55635132')) {function content_5b34e2bf350218_55635132($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\products\\CPMS\\model\\lib\\smarty/plugins/modifier.replace.php';
...
<head>
 ...
 :: Designations-<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['a_TemplateData']->value['clientName'],true);?>
</title>
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" onclick="return false;">
                        <h2><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['id']>0) {?>Edit<?php } else { ?>Add New<?php }?></h2>
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['showForm'])) {?>
                    ...
                    <div class="box-content row" style="<?php if ($_smarty_tpl->tpl_vars['showForm']->value) {?>display: block;<?php } else { ?>display: none;<?php }?>">
                        <div class="col-lg-12 col-md-12">
                                <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['id']>0) {?>
                                    <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['id'];?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['designationId'] = new Smarty_variable($_tmp1, null, 0);?>
                                <?php } else { ?>
                                    <?php $_smarty_tpl->tpl_vars['designationId'] = new Smarty_variable(0, null, 0);?>
                                <?php }?>
                                <input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['designationId']->value;?>
"/>
...
"  data-validation-url="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['ajaxFilePath']->value,'params'=>array("do"=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['VALIDATE'],"id"=>$_smarty_tpl->tpl_vars['designationId']->value)),$_smarty_tpl);?>
" data-validation-error-msg="Alphanumeric values only" value='<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['name'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['name'];
}?>' autocomplete="off" placeholder=" name"/>
                                </div>
                                
                                <div class="form-group col-xs-4">
                                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['status'])) {?>
                                        <?php $_smarty_tpl->tpl_vars["status"] = new Smarty_variable($_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['status'], null, 0);?>
                                    <?php } else { ?>
...
" data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['notes'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['notes'];
}?></textarea>
                                </div>
                                
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" id='addDesignation'  type="submit" name="add_designation" value="<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['id'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['designationData']['id']>0) {?>Save<?php } else { ?>Add<?php }?>"/>&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" name="addDesignation" value="Add"/>
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['search_designation'])) {?>
                        <?php $_smarty_tpl->tpl_vars['showForm'] = new Smarty_variable(true, null, 0);?>
                    <?php } else { ?>
                        <?php $_smarty_tpl->tpl_vars['showForm'] = new Smarty_variable(false, null, 0);?>
                    <?php }?>
...
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['searchData']['notes'];
                                ...
                                <div class="form-group col-xs-12" style="border:0px solid red;text-align: center; padding-top: 35px;">
                                    <input class="btn btn-primary" type="submit" name="search_designation" value="Search"/>&nbsp;&nbsp;&nbsp;
         ...
         <form method="post" class="form-inline bulkForm" action="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['actionPage']->value),$_smarty_tpl);?>
">
        <div class='row'>
            <div class="box">
                <div class="box-inner">
                    <div class="box-header well">
                        <h2><i class="glyphicon glyphicon-th-large"></i> Designations</h2>
                        <div class="box-icon">
...
"<?php }?>><?php echo $_smarty_tpl->tpl_vars['head']->value['name'];?>
                                ...
                                <tfoot>  
                                    <tbody>
                                    <?php if ($_smarty_tpl->tpl_vars['a_TemplateData']->value['allDesignations']) {?>
                                        <?php  $_smarty_tpl->tpl_vars['details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['details']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['a_TemplateData']->value['allDesignations']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" />
                                               ...
                                               <td>
                                                   <a class="btn btn-info btn-small" data-toggle="tooltip" data-original-title="Edit payment term." href="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['actionPage']->value,'params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['EDIT'])),$_smarty_tpl);?>
">
                                                       <i class="glyphicon glyphicon-edit icon-white"></i>
                                                       Edit
                                                   </a>
                                                   <a class="btn btn-danger btn-small delete" data-toggle="tooltip" data-original-title="Delete payment term." href="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['actionPage']->value,'params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['DELETE'])),$_smarty_tpl);?>
">
                        ...
                        <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['allDesignations'])&&$_smarty_tpl->tpl_vars['a_TemplateData']->value['allDesignations']) {?>
