<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-06-28 18:36:25
         compiled from "C:/xampp/htdocs/products/CPMS/view/projects.tpl" */ ?>
<?php /*%%SmartyHeaderCode:222095b34dd5141e791-69302669%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2b4597d277021a28f2ff97406204c2852f031834' => 
    array (
      0 => 'C:/xampp/htdocs/products/CPMS/view/projects.tpl',
      1 => 1454251753,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '222095b34dd5141e791-69302669',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b34dd516abfc6_59165184',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b34dd516abfc6_59165184')) {function content_5b34dd516abfc6_59165184($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\products\\CPMS\\model\\lib\\smarty/plugins/modifier.replace.php';
...
<br/>
    ...
    <?php }?>
    <form action="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['actionPage']->value,'params'=>array("id"=>$_smarty_tpl->tpl_vars['projectId']->value)),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['branchId']->value==$_smarty_tpl->tpl_vars['details']->value->id) {?>selected='selected'<?php }?>>
                                ...
                                <?php }?>
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" data-validation="required server" data-validation-url="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['ajaxFilePath']->value,'params'=>array("do"=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['VALIDATE'],"id"=>$_smarty_tpl->tpl_vars['projectId']->value)),$_smarty_tpl);?>
" data-validation-error-msg="Name required" placeholder="Project name" value="<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['projectData']['name'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['projectData']['name'];
}?>">
                                </div>

                                <div class="form-group col-xs-4">
                                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['projectData']['progressId'])) {?>
                                        <?php $_smarty_tpl->tpl_vars["progressId"] = new Smarty_variable($_smarty_tpl->tpl_vars['a_TemplateData']->value['projectData']['progressId'], null, 0);?>
                                    <?php } else { ?>
                                    ...
                                    <select id="progressId" name="progressId" class="form-control chosen-select" data-validation="number" data-validation-error-msg="Invalid progress">
                                        <?php  $_smarty_tpl->tpl_vars['details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['details']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['a_TemplateData']->value['progressId']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['details']->key => $_smarty_tpl->tpl_vars['details']->value) {
$_smarty_tpl->tpl_vars['details']->_loop = true;
?>
                                            <option value="<?php echo $_smarty_tpl->tpl_vars['details']->value->id;?>
...
" />
                                           ...
                                           <td><?php echo $_smarty_tpl->tpl_vars['details']->value->startedDateF;?>
</td>
                                           <td><?php echo $_smarty_tpl->tpl_vars['details']->value->completedDateF;?>
</td>
...
">
                                               ...
                                               <a class="btn btn-info btn-small" data-toggle="tooltip" data-original-title="Edit project." href="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['actionPage']->value,'params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['EDIT'])),$_smarty_tpl);?>
">
                                                   <i class="glyphicon glyphicon-edit icon-white"></i>
                                                   Edit
                                               </a>
                                               <a class="btn btn-danger btn-small delete" data-toggle="tooltip" data-original-title="Delete project." href="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['actionPage']->value,'params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['DELETE'])),$_smarty_tpl);?>
">
...
">
                                               ...
                                               <a class="btn btn-info btn-addStages btn-small" data-toggle="tooltip" data-original-title="Expenses." href="<?php echo smarty_function_actionurl(array('page'=>'materialexpenses','params'=>array('projectId'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['SHOW_ADD_FORM'])),$_smarty_tpl);?>
">
                                                   <i class="glyphicon glyphicon-plus icon-white"></i>
                                                   Material Expense
                                               </a>
                                               <a class="btn btn-info btn-addStages btn-small" data-toggle="tooltip" data-original-title="Expenses." href="<?php echo smarty_function_actionurl(array('page'=>'labourwages','params'=>array('projectId'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['SHOW_ADD_FORM'])),$_smarty_tpl);?>
">
                                                   <i class="glyphicon glyphicon-plus icon-white"></i>
                                                   Labour Wages
                                               </a>
