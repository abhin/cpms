<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-02-11 11:02:43
...
<?php if ($_valid && !is_callable('content_54db28c407ffa5_24503170')) {function content_54db28c407ffa5_24503170($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include 'D:\\xampp\\htdocs\\products\\CPMS\\model\\lib\\smarty/plugins/modifier.capitalize.php';
...
<head>
    ...
    <title>CPMS :: Projects-<?php echo smarty_modifier_capitalize($_smarty_tpl->tpl_vars['a_TemplateData']->value['clientName'],true);?>
</title>

    

        
        <link id="bs-css" href="../../css/theme/jquery-ui.css" rel="stylesheet">
...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="<?php echo smarty_function_actionurl(array('page'=>$_smarty_tpl->tpl_vars['a_TemplateData']->value['homePage']),$_smarty_tpl);?>
"> 
...
">
                        ...
                        <ul class="nav nav-pills nav-stacked main-menu">
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['a_TemplateData']->value['homePage']=="home") {?>
                            <li>
...
" method="post" class="form-inline addForm">
                                <div class="form-group has-feedback">
                                    <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['projectData']['id'])) {?>
                                        <input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['projectData']['id'];?>
"/>
                                    <?php }?>
                                    <label for="name" class="control-label">Name</label>
                                    <input type="text" id="name" name="name" class="form-control" data-validation="alphanumeric" data-validation-allowing="-&@%_ " data-validation-error-msg="Alphanumeric values only" value="<?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['projectData']['name'])) {
...
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['projectData']['completedDate'];
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <textarea id="notes" name="notes" class="form-control" data-validation="alphanumeric" data-validation-allowing="-&@%_ " data-validation-error-msg="Alphanumeric value only" data-validation-optional="true"> <?php if (isset($_smarty_tpl->tpl_vars['a_TemplateData']->value['projectData']['notes'])) {
echo $_smarty_tpl->tpl_vars['a_TemplateData']->value['projectData']['notes'];
                                    ...
                                    <input class="btn btn-default btn" type="submit" name="add_project" value="Add"/>
                                </div>
                            </form>
                            </div>
                        </div>
...
">
                            <div class="breadcrumb">
                                <div id="bulk-action" style="border:0px solid red;width: 220px;">
                                    Bulk Action:
...
" />
                                           ...
                                           <td style="width:15%">
                                               <a class="btn btn-success btn-small" data-toggle="tooltip" data-original-title="View All Project Details." href="<?php echo smarty_function_actionurl(array('page'=>'projects','params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id)),$_smarty_tpl);?>
">
                                                   <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                                                   View
                                               </a>
                                               <a class="btn btn-info btn-small" data-toggle="tooltip" data-original-title="Edit project." href="<?php echo smarty_function_actionurl(array('page'=>'projects','params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>1)),$_smarty_tpl);?>
">
                                                   <i class="glyphicon glyphicon-edit icon-white"></i>
                                                   Edit
                                               </a>
                                               <a class="btn btn-danger btn-small" data-toggle="tooltip" data-original-title="Delete project." href="<?php echo smarty_function_actionurl(array('page'=>'projects','params'=>array('id'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>2)),$_smarty_tpl);?>
">
                                                   <i class="glyphicon glyphicon-trash icon-white"></i>
                                                   Delete
                                               </a>
                                                   
                                               <a class="btn btn-info btn-addAdvance btn-small" data-toggle="tooltip" data-original-title="Add advances." href="<?php echo smarty_function_actionurl(array('page'=>'advances','params'=>array('projectId'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>500)),$_smarty_tpl);?>
">
                                                   <i class="glyphicon glyphicon-plus icon-white"></i>
                                                   Advance
                                               </a>
                                                   
                                               <a class="btn btn-info btn-addStages btn-small" data-toggle="tooltip" data-original-title="Add Stages." href="<?php echo smarty_function_actionurl(array('page'=>'stages','params'=>array('projectId'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>500)),$_smarty_tpl);?>
">
                                                   <i class="glyphicon glyphicon-plus icon-white"></i>
                                                   Stage
                                               </a>
                                               <a class="btn btn-info btn-addStages btn-small" data-toggle="tooltip" data-original-title="Add Expenses." href="<?php echo smarty_function_actionurl(array('page'=>'expenses','params'=>array('projectId'=>$_smarty_tpl->tpl_vars['details']->value->id,'do'=>500)),$_smarty_tpl);?>
">
                                                   <i class="glyphicon glyphicon-plus icon-white"></i>
                                                   Expense
                                               </a>
        ...
        <footer class="row">
            ...
            <p class="col-md-3 col-sm-3 col-xs-12 powered-by">
                A <a href="http://www.es4em.com">ES4EM Technologies</a> Product
            </p>
        </footer>
